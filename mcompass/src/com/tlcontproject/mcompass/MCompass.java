...
public class MCompass extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHeadingView.setBackgroundColor(0xff808080);
        mHeadingView.setTextColor(0xffffffff);
        mHeadingView.setShadowLayer(1, 0, 0, Color.BLACK);
        mHeadingView.setGravity(Gravity.CENTER_HORIZONTAL);
        mHeadingView.setPadding(0, 15, 0, 0);
    ...
    protected void onResume() {
        ...
        boolean reversedRing=sharedPref.getBoolean(KEY_REVERSED_RING_PREFERENCE, true);
